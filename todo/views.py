...
def loginuser(request):
    if request.method == 'GET':
        ...
        if user is None:
            return render(request, 'todo/login.html', {'form': AuthenticationForm(), 'error': 'incorrect username/password'})
        else:
            login(request, user)
            return redirect('currenttodos')
...
def viewtodo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/createtodo.html', {'form': form, 'error': 'Bad data passed in'})
